...
const steps = [
  {
    ...
    title: "Crie",
    description:
      "Configure seu torneio em minutos — escolha o formato, esporte, datas e regulamento.",
  },
  {
    icon: Users,
    step: "02",
    title: "Convide",
    description:
      "Compartilhe o link do torneio. Os jogadores se inscrevem e garantem a vaga facilmente.",
  },
  {
    icon: Play,
    step: "03",
    title: "Dê o Play",
    description:
      "Acompanhe os placares ao vivo, avance as chaves automaticamente e coroe o seu campeão.",
  },
];
    ...
    <section id="how-it-works" className="py-24 bg-background">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-muted-foreground mb-16 max-w-lg mx-auto">
          Três passos simples para organizar um torneio com perfeição.
        </p>
